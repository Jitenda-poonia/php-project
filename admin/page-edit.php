			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<span class="page-subhead-line"><strong><a href="dashboard.php">Dashboard</a> >> Edit Pages </span>
							...
							<div class="panel-body">
								...
								<form action="page-update.php" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input class="form-control" name="title" type="text" value="<?= $pageData['title']??'' ?>">
									</div>
									<div class="form-group">
										<label>Enter Heading</label>
										<input class="form-control" name="heading" type="text" value="<?= $pageData['heading']??''?>">
									</div>
									<div class="form-group">
										<label>Enter Ordering</label>
										<input class="form-control" name="ordering" type="number" value="<?= $pageData['ordering']??''?>">
									</div>
									...
									<div class="form-group">
										...
										<select name="status" class="form-control">
											...
											<option value="1" <?= (($pageData["status"]??"")==1)?"selected":"" ?>>Enable</option>
											<option value="2" <?= (($pageData["status"]??"")==2)?"selected":"" ?>>Disable</option>
										</select>
									</div>
									<div class="form-group">
										<label>Enter url key </label>
										<input class="form-control" name="url_key" type="text" value="<?= $pageData['url_key']??''?>">
									</div>
									<div class="form-group">
										<label>Enter description </label>
										<textarea name="description" id="" cols="30" rows="10" ><?= $pageData['description']??''?></textarea>
									</div>
									<div class="row">
										<div class="col-md-12">
